    ...
    <div id="content">
        <div class="content_inner">
            ...
            <div class="find-password-page" ng-controller="FindIdCtrl as findIdCtrl">
                <div class="find-password-header">ë¹ë°ë²í¸ ì°¾ê¸°</div>
                <div class="find-password-content">
                    <div class="find-password-div">ë±ë¡íì  <span>E-Mail</span> ì£¼ìë¥¼ ìë ¥íì¸ì.</div>
                    <div><input type="text" name="txtEmail" placeholder="E-Mail" class="txtEmail" id="txtEmail"></div>
                </div>
                <div class="find-password-button"><button id="passwordRequest" onclick="loginCheck();">íì¸</button></div>
            </div>
            </form>
      </div>
    </div>
